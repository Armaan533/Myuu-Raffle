    ...
    async def rafflelist(self, ctx):
        if not str(ctx.guild.id) in mn.raffledbase.list_collection_names():
            ...
            if guild.count_documents({"type":"buyer"}) == 0:
                ...
                rafflelist1.set_footer(text= f"Requested by {ctx.author.name+ctx.author.discriminator} | Page 1 of {Embeds}", icon_url=self.client.user.avatar_url)
                rafflelist2.set_footer(text= f"Requested by {ctx.author.name+ctx.author.discriminator} | Page 2 of {Embeds}", icon_url=self.client.user.avatar_url)
                rafflelist3.set_footer(text= f"Requested by {ctx.author.name+ctx.author.discriminator} | Page 3 of {Embeds}", icon_url=self.client.user.avatar_url)
                rafflelist4.set_footer(text= f"Requested by {ctx.author.name+ctx.author.discriminator} | Page 4 of {Embeds}", icon_url=self.client.user.avatar_url)
                rafflelist5.set_footer(text= f"Requested by {ctx.author.name+ctx.author.discriminator} | Page 5 of {Embeds}", icon_url=self.client.user.avatar_url)
                rafflelist6.set_footer(text= f"Requested by {ctx.author.name+ctx.author.discriminator} | Page 6 of {Embeds}", icon_url=self.client.user.avatar_url)
                rafflelist7.set_footer(text= f"Requested by {ctx.author.name+ctx.author.discriminator} | Page 7 of {Embeds}", icon_url=self.client.user.avatar_url)
