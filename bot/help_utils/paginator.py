...
class BotPages(discord.ui.View):
    def __init__(
        ...
        *,
        ...
        self.clear_items()  # clears any previously added buttons and stuff
        self.fill_items()   # adds new items (buttons, etc.)

# This function gets initiated in init and fills items (buttons, etc.) not pages
